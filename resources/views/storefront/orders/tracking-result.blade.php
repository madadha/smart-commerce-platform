            ...
            <div class="scp-order-hero">
                <div>
                    <span class="scp-order-badge">
                        {{ __('storefront.order_tracking.result_badge') }}
                    </span>

                    <h1>{{ __('storefront.order_tracking.result_title') }}</h1>

                    <p>{{ __('storefront.order_tracking.result_description') }}</p>
                </div>
            ...
            <div class="scp-order-details-grid">
                ...
                <aside class="scp-order-sidebar">
                    ...
                    <div class="scp-order-actions">
                        <a href="{{ route('storefront.orders.track', ['lang' => $locale]) }}" class="scp-order-primary-btn">
                            {{ __('storefront.order_tracking.track_another') }}
                        </a>
