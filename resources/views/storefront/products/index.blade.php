    ...
    <section class="scp-product-details-section">
        <div class="scp-container">
            ...
            <div class="scp-breadcrumbs">
                ...
                <span>/</span>
                <strong>{{ $toLocalizedString($product->getName($locale)) }}</strong>
            </div>
                ...
                <div class="scp-product-gallery">
                    <div class="scp-product-main-image">
                        @if($productImage($product))
                            <img src="{{ $productImage($product) }}" alt="{{ $toLocalizedString($product->getName($locale)) }}">
                        @else
    ...
    @foreach($product->media->take(4) as $mediaItem)
        ...
        @if($mediaPath)
            <div class="scp-product-thumb">
                <img src="{{ asset('storage/' . $mediaPath) }}" alt="{{ $toLocalizedString($product->getName($locale)) }}">
            </div>
        @endif
    @endforeach
@endif
                ...
                <div class="scp-product-info">
                    ...
                    <h1>{{ $toLocalizedString($product->getName($locale)) }}</h1>
                        ...
                        <article class="scp-product-card">
                            <div class="scp-product-image">
                                @if($productImage($relatedProduct))
                                    <img src="{{ $productImage($relatedProduct) }}" alt="{{ $toLocalizedString($relatedProduct->getName($locale)) }}">
                                @else
                            ...
                            <div class="scp-product-body">
                                ...
                                <h3>{{ $toLocalizedString($relatedProduct->getName($locale)) }}</h3>
